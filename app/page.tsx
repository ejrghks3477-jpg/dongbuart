          ...
          <div className="text-right text-xs">
            {userEmail ? (
              <div className="space-y-1">
                <div className="text-slate-400">로그인 계정</div>
                <div className="font-mono text-emerald-300">{userEmail}</div>
                <button
                  type="button"
                  disabled={authLoading}
                  onClick={handleLogout}
                  className="mt-1 rounded-full bg-slate-800 px-3 py-1 text-[11px] text-slate-100 hover:bg-slate-700 disabled:opacity-60"
                >
              ...
              <div className="space-y-1">
                <div className="text-slate-400">로그인이 필요하면</div>
                <a
                  href="/login"
                  className="inline-block rounded-full bg-emerald-500 px-3 py-1 text-[11px] font-semibold text-slate-900 hover:bg-emerald-400"
                >
                  로그인 / 회원가입
                </a>
              </div>
                    ...
                    <div className="mb-1 flex items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2 text-[11px] text-slate-500">
                        ...
                        <button
                          ...
                          className="rounded-full bg-slate-800 px-2 py-0.5 text-[11px] text-slate-300 hover:bg-red-500 hover:text-white"
                        >
                          삭제
                        </button>
                      </div>
          ...
          {activeTab === "car" && (
            <section>
              ...
              <form onSubmit={submitCarLog} className="space-y-3">
                ...
                />
                <textarea
                  placeholder="최근 수리 내용 (정비소, 교체 부품 등)"
                  value={carService}
